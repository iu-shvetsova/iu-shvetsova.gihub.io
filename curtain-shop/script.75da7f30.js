...
},{"dom7/dist/dom7.modular":"../node_modules/dom7/dist/dom7.modular.js","ssr-window":"../node_modules/ssr-window/dist/ssr-window.esm.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/swiper/css/swiper.css":[function(require,module,exports) {
...
if (header) {
  ...
  if (window.matchMedia('(max-width: 1024px)').matches) {
    var menuWrapper = header.querySelector('.site-header__nav-wrapper');
    var toggleMenuBtn = header.querySelector('.site-header__nav-button');
    var navLinks = header.querySelectorAll('.site-header__nav-link');

    var closeMenu = function closeMenu() {
      menuWrapper.classList.remove('site-header__nav-wrapper--opened');
      document.removeEventListener('click', onWindowClick);
    };

    var onWindowClick = function onWindowClick(evt) {
      if (!evt.target.matches('.site-header__nav-wrapper, .site-header__nav-wrapper *')) {
        closeMenu();
      }
    };
    ...
    toggleMenuBtn.addEventListener('click', function (evt) {
      evt.stopPropagation();
      menuWrapper.classList.toggle('site-header__nav-wrapper--opened');
...
var productsBlock = document.querySelector('.our-products');

if (productsBlock) {
  var curtainSlider = new _swiper.default('.our-products__images-wrapper--curtain', {
    loop: true,
    pagination: {
  ...
  var clothSlider = new _swiper.default('.our-products__images-wrapper--cloth', {
    loop: true,
    pagination: {
      el: '.swiper-pagination',
      type: 'fraction'
...
},{"smooth-scroll":"../node_modules/smooth-scroll/dist/smooth-scroll.polyfills.min.js","swiper":"../node_modules/swiper/js/swiper.esm.bundle.js","swiper/css/swiper.css":"../node_modules/swiper/css/swiper.css"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
